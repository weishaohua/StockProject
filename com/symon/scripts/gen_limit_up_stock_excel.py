...
if __name__ == '__main__':
    first_trade_day = ths.get_first_trade_day("20230101")
    limit_up_stock_file_path = f"../crawler/ths/data/{first_trade_day}-涨停股票.csv"
    ...
    write_file_path = f'../crawler/ths/data/{first_trade_day}-情绪周期分析.xlsx'
