...
if __name__ == '__main__':
    ...
    df = pd.read_csv('../crawler/ths/data/2025-涨停炸板股票.csv', encoding='utf-8')
    ...
    # dfcf.save_data(all_stock, f'../crawler/ths/data/2025-昨日涨停炸板股票今日竞价数据.csv', True, 'w', 'utf-8')
    dfcf.save_data(all_stock, f'../crawler/ths/data/2025-昨日涨停炸板股票今日竞价数据.csv', False, 'a', 'utf-8')
